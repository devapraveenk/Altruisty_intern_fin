...
def startuprun():
    ...
    img=[['image/flinto.jpg', 'image/netmeds.jpg','image/sulekha.png'],['image/flinto.jpg', 'image/netmeds.jpg','image/sulekha.png'],['image/flinto.jpg', 'image/netmeds.jpg','image/sulekha.png']]
    ...
    for f in range(3):
            ...
            with col2:
                ...
                st.page_link("https://www.netmeds.com/",label="To connect")
            with col3:
